...
<Steps>
    ...
    <Step title="Create Context token">
        ...
        1. Create a context: `POST /api/v1/contexts` <Badge>[ACCESS_TOKEN]</Badge>
        2. Create context token: `POST /api/v1/contexts/{context_id}/token` <Badge>[ACCESS_TOKEN]</Badge>.
    ...
    <Step title="Call Agent">
        Send message to the agent: `POST /api/v1/a2a/{provider_id}` <Badge>[ACCESS_TOKEN]</Badge>.
        <Note>
...
<Steps>
    ...
    <Step title="Upload file">
        ...
        call `POST /api/v1/files?context_id={context_id}` <Badge>[CONTEXT_TOKEN]</Badge>.
        <Note>
