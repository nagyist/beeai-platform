...
**Import the settings extension**: Import `SettingsExtensionServer`, `SettingsExtensionSpec`, `SettingsRender`, and field types from `beeai_sdk.a2a.extensions.ui.settings`.
