...
description: "Customize how your agents appear and behave in the Agent Stack interface"
---

Your agent can leverage certain features of the platform to achieve the best possible user experience. When you yield specific content types from your agent, the Agent Stack automatically renders them with appropriate visual representations.

## Markdown Support

When you yield text content, the Agent Stack automatically renders it as Markdown, providing rich formatting capabilities.
...
The Agent Stack leverages the A2A extensions concept, which allows you to easily extend message metadata in specific formats that the GUI can render in specialized ways.
...
The Agent Stack currently supports two types of GUI extensions:
