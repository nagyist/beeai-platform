...
description: "Migrate from ACP (Agent Communication Protocol) to A2A (Agent2Agent) Protocol for Agent Stack v0.3.x+."
---

## Quick Migration Checklist

✅ Update dependencies: `acp_sdk` → `agentstack_sdk`
...
```toml
dependencies = ["agentstack-sdk>=0.4.0"]
```
