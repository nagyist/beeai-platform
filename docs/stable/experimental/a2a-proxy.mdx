...
2. **Adding Agent Details extension** - Automatically injects the necessary [AgentDetail](/stable/agent-integration/agent-details) extension data that enables the agent to work within the Agent Stack ecosystem
