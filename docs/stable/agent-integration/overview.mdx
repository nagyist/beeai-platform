...
This enables your agent to leverage platform services like [LLM providers](/stable/agent-integration/llm-proxy-service), [file storage](/stable/agent-integration/files), [vector databases](/stable/agent-integration/rag), and rich UI components. That's all without rewriting your core agent logic.
