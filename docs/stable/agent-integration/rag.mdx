...
- [LLM extension](/stable/agent-integration/llm-proxy-service)
- [Multi-turn conversations](/stable/agent-integration/multi-turn)
- [File handling](/stable/agent-integration/files)
