...
Generates a context token with specific permissions. Context tokens are used to grant agents access to platform resources through the [Platform API extension](/stable/custom-ui/client-sdk/extensions#dependency-injection-service-extensions).
...
- **[Extensions](/stable/custom-ui/client-sdk/extensions)** - Learn how to use the API client with extension fulfillments
