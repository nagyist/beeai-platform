...
- **[Extensions](/stable/custom-ui/client-sdk/extensions)** - Deep dive into service and UI extensions
- **[API Client](/stable/custom-ui/client-sdk/api-client)** - Complete reference for the AgentStack platform API client
