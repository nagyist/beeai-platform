...
- **Example:** [agentstack-sdk-py/examples/oauth.py](https://github.com/i-am-bee/agentstack/blob/main/apps/agentstack-sdk-py/examples/oauth.py)
...
- **Example:** [agentstack-sdk-py/examples/secrets_agent.py](https://github.com/i-am-bee/agentstack/blob/main/apps/agentstack-sdk-py/examples/secrets_agent.py)
...
- **Example:** [agentstack-sdk-py/examples/request_form_agent.py](https://github.com/i-am-bee/agentstack/blob/main/apps/agentstack-sdk-py/examples/request_form_agent.py)  
...
- **Example:** [agentstack-sdk-py/examples/settings_agent.py](https://github.com/i-am-bee/agentstack/blob/main/apps/agentstack-sdk-py/examples/settings_agent.py)  
