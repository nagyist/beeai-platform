...
- **[Forms](/development/agent-integration/forms)**: Collect structured user input through interactive forms
- **[Citations](/development/agent-integration/citations)**: Display source references with clickable inline links
- **[Trajectory](/development/agent-integration/trajectory)**: Visualize agent reasoning steps with execution traces
- **[Canvas](/development/agent-integration/canvas)**: Handle visual editing and canvas-based interactions
- **[Agent Detail](/development/agent-integration/agent-details)**: Display agent-specific information and metadata
- **[Error](/development/agent-integration/error)**: Render structured error messages
- **[Settings](/development/agent-integration/agent-settings)**: Display and manage agent settings
- **OAuth**: Handle OAuth authentication flows
- **Approval**: Request user approval before executing actions (e.g., tool calls)
