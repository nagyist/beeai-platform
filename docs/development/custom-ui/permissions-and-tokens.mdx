...
description: User roles, context tokens, and permission scopes for platform access
---
...
<Note>
    **How it works**
    ...
    1. The client passes the context token via the `Authorization` header
