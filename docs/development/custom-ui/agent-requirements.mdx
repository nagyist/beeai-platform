...
Agent Stack extends the [A2A Protocol](https://a2a-protocol.org/) with
...
Deprecated. Planned for removal in the next release. Use [Settings Form](#settings-form) instead.
