...
Note: Want to deploy BeeAI for your team? BeeAI can also run as a hosted platform with full Kubernetes infrastructure. Check out the [Deployment Guide](/how-to/deployment-guide).
