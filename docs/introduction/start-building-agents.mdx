...
Now that your Agent Stack is up and running, and you know how to run an agent via the GUI or CLI, it’s time to create your first agent.

With the Agent Stack SDK, you can build an agent that automatically registers with the Agent Stack — no extra setup required.
