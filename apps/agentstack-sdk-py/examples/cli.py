...
async def cli(base_url: str, context_id: str) -> None:
    async with httpx.AsyncClient(timeout=30) as httpx_client:
        ...
        llm_spec = agentstack_sdk.a2a.extensions.LLMServiceExtensionSpec.from_agent_card(card)
        mcp_spec = agentstack_sdk.a2a.extensions.MCPServiceExtensionSpec.from_agent_card(card)
        trajectory_spec = agentstack_sdk.a2a.extensions.TrajectoryExtensionSpec.from_agent_card(card)
        trajectory_client = (
            agentstack_sdk.a2a.extensions.TrajectoryExtensionClient(trajectory_spec) if trajectory_spec else None
        )
            ...
            try:
                ...
                while not no_task and (
                    ...
                    message = a2a.types.Message(
                        ...
                        metadata=(
                            agentstack_sdk.a2a.extensions.LLMServiceExtensionClient(llm_spec).fulfillment_metadata(
                                llm_fulfillments={
                                    ...
                                    key: agentstack_sdk.a2a.extensions.services.llm.LLMFulfillment(
                        ...
                        | (
                            agentstack_sdk.a2a.extensions.MCPServiceExtensionClient(mcp_spec).fulfillment_metadata(
                                mcp_fulfillments={
                                    # Demonstration only: we ignore the asks and just configure Agent Stack proxy for everything
