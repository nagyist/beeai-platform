...
from agentstack_server.api.schema.mcp import McpProvider, Tool, Toolkit
from agentstack_server.configuration import Configuration
from agentstack_server.domain.models.mcp_provider import (
    McpProviderLocation,
...
from agentstack_server.exceptions import EntityNotFoundError, GatewayError, PlatformError
...
class McpService:
    ...
    async def create_toolkit(self, *, tools: list[str]) -> Toolkit:
        ...
        from agentstack_server.jobs.tasks.mcp import delete_toolkit  # Avoid circual import
